...
# Em programação utilizamos o comando se, se alguma condição verdadeira executa um bloco de códigos, 
# e podemos utilizar um bloco se não para executar quando a condição for falsa.
